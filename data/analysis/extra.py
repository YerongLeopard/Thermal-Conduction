...
pl.xlabel('$1/N_y^2$',fontsize=22)
h=pl.ylabel('$A$',fontsize=22)
h.set_rotation(0)

pl.figure(2)
pl.plot(x2,b,'ob',markersize=8,label="$N_x>10$")
pl.plot(x2,b,'-b',markersize=8)
pl.xlabel('$1/N_y$',fontsize=22)
h=pl.ylabel('$B$',fontsize=22)
h.set_rotation(0)

pl.figure(3)
pl.plot(x3,c,'ob',markersize=8,label="$N_x>10$")
pl.plot(x3,c,'-b',markersize=8)
pl.xlabel('$N_y^2$',fontsize=22)
h=pl.ylabel('$C$',fontsize=22)
h.set_rotation(0)
#########################################50
...
ax.tick_params(which='both',width=2,length=12) # setting length and width of tick marks
